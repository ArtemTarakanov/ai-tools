        ...
        <section className="bg-[#1E252B] min-h-[650px] flex items-center justify-around max-md:flex-col-reverse max-md:px-4 max-md:py-5 max-md:gap-4.5">
            <div className="flex flex-col gap-15 max-md:gap-4">
                ...
                <div className="flex flex-col gap-7.5 max-md:gap-4" >
                    <h1 className="font-['Poppins'] font-medium text-[50px] leading-[140%] max-w-[600px] text-[#FFFFFFE5] max-md:text-[32px]">Awesome tools for Designer & Developer.</h1>
                    <p className="font-['Poppins'] font-normal text-[18px] leading-[30px] max-w-[487px] text-[#FFFFFF8C] max-md:text-[17px] max-md:w-full">Antool is a web collection of information on paid or free Design and Development tools</p>
                </div>
                <form className="flex items-center gap-2 bg-[#283036] rounded-[15px] w-[500px] px-[18px] py-[8px] max-md:w-full max-md:px-3 max-md:py-2">
                    <input
                        type="text"
                        placeholder="Find more than 430+ tools..."
                        className="bg-transparent flex-1 text-white placeholder:text-[#FFFFFF8C] outline-none max-md:text-sm"
                    />
                    <button
                        type="submit"
                        className="bg-[#FF6E30] text-white font-semibold px-10 py-3 rounded-[10px] max-md:px-6 max-md:py-2 max-md:text-sm"
                    >
                        Search
                    </button>
                </form>
            ...
            <div className="flex-shrink-0 max-md:max-w-full">
                <svg className="max-md:w-full max-md:h-auto" width="589" height="568" viewBox="0 0 589 568" fill="none" xmlns="http://www.w3.org/2000/svg">
